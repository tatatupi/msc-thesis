...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.7\textwidth]{Imagens/fusion_accuracy.pdf}
...
\begin{figure}[!htb]
	...
	\caption[Expected advantages in sensor fusion]{Sensor fusion categorization hierarchy based on expected advantages. The lowest white boxes represent the advantages grouped two ways: autenthicity or availability; and sensor architecture, that is heterogeneous, homogeneous or both.}
