...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.6\textwidth]{Imagens/rought_set.pdf}
...
Being the most popular method in the fusion community, probabilistic methods for data fusion and its application on state estimation for sampled-data systems will be the focus of our study. A new data challenge is often present when complex sensor architectures are used to observe system states: sampling irregularity.
