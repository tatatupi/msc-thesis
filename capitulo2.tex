...
The most traditional are NTP and use of GPS. Other methods were proposed and table X summarizes them.

\begin{table}[!htb]
	\renewcommand{\arraystretch}{1.3}
	\caption[Comparison of time synchronization methods]{Comparison of time synchronization methods. Parameters are \textit{Sync Precision, Energy Efficiency (E.E.) and Complexity (Comp).}. Adapted from \citep{Kaur2015}}
	\label{tab:sync}
	\centering
	\begin{flushleft}
		
		{
			...
			\begin{tabularx}{\linewidth}{
				...
				LiMing & Low synchronization error & Not scalable & Unknown  \ \ \ Low E.E. Low Comp. \\ \\
...
Nevertheless, it is aways costly and sometimes it may not be worth it.
