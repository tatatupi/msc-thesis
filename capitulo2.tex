...
A summary of causes and effects that time delay causes in an estimator are illustraed in Figure \ref{fig:diagrama_delay}.

\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.85]{Imagens/scheme_time-delay.pdf}
	\caption{Irregular sampling diagram, showing the main causes (in orange) and effects (in dark blue) of time delay irregularity. The light blue boxes indicate different types that lead to different effects.}
