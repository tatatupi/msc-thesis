%-------------------------------------------------------------------------------
\chapter{Simulation Methods and Assumptions}\label{sec:methods}
...
\todo[inline]{Inserir texto que faz um link entre amostragem irregular e fusão sensorial.}
...
A ideia é começar com uma explicação do algoritmo de filtro de kalman e suas versões EKF e UKF.
Expandir a explicação para o filtro de partículas, caso seja utilizado nas simulações.
...
\section{State Estimation with Aperiodic Sampling}
