...
Considere um robô móvel não-holonômico, cujo modelo de processo cinemático é dado por
...
\end{equation}
\noindent
em que $p_\textrm{x}$ e $p_\textrm{y}$ são as coordenadas de posição, $\theta$ a orientação angular, $v$ a velocidade linear e as entradas $u_1$ e $u_2$ são, respectivamente, a velocidade angular ($\omega$) e a aceleração linear (a).
...
%		\caption{}
	...
	\begin{subfigure}
		\centering
		\includegraphics[scale=0.4]{Imagens/noise2.eps}	
		%		\caption{}
		\label{fig:noise2}
	\end{subfigure}
...
%		\caption{}
	...
	\begin{subfigure}
		\centering
		\includegraphics[scale=0.4]{Imagens/samp2.eps}
		%		\caption{}
		\label{fig:samp2}
	\end{subfigure}
...
%		\caption[entrada]{}
	...
	\begin{subfigure}
	\centering
	\includegraphics[scale=0.4]{Imagens/dtudty2.eps}
	%		\caption[entrada]{}
	\label{fig:dtu2}
	\end{subfigure}
