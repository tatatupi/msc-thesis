...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Imagens/samp_results_J.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Imagens/samp_results_test.eps}
	\caption[entrada]{Root mean square error variation, as a function of $\lambda$ for both KF algorithms, considering and not considering time-stamp}
	\label{fig:sampTests}
\end{figure} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Imagens/usamp_results_J.eps}
	\caption[entrada]{Root mean square error variation, as a function of $\lambda$ for both KF algorithms, considering and not considering time-stamp}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Imagens/usamp_results_test.eps}
	\caption[entrada]{Root mean square error variation, as a function of $\lambda$ for both KF algorithms, considering and not considering time-stamp}
	\label{fig:usampTests}
\end{figure} 
