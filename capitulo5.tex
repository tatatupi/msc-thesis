...
\subsection{Without Time Delay}\label{sec:notimedelay}
...
\subsection{With Time Delay}\label{sec:timedelay}

\subsubsection{Measurement Signal-to-Noise Ratio Variation}\label{sec:ruido2}

\subsubsection{Average Sampling Rate Variation}\label{sec:lambda2}

\subsubsection{Regular and Average Irregular Time Interval Relation Variation}\label{sec:alpha2}
